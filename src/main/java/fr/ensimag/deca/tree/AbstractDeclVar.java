...
public abstract class AbstractDeclVar extends Tree {
	...
	protected abstract void codeGenDeclVar(DecacCompiler compiler, RegisterOffset addr);

	protected abstract void codeGenDeclVarLocale(DecacCompiler compiler, RegisterOffset addr);
}
