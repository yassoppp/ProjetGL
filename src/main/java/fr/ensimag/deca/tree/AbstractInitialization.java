...
public abstract class AbstractInitialization extends Tree {
	...
	protected abstract void codeGenInitialization(DecacCompiler compiler, VariableDefinition variableDefinition);

	protected abstract void codeGeninitializationField(DecacCompiler compiler);
