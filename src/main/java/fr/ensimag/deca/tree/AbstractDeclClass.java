...
public abstract class AbstractDeclClass extends Tree {
	...
	protected abstract void codeGenTabledeMethode(DecacCompiler compiler);

	public abstract AbstractIdentifier getName();
	public abstract AbstractIdentifier getNameSuper();

	protected abstract void codeGenMethode(DecacCompiler compiler);
